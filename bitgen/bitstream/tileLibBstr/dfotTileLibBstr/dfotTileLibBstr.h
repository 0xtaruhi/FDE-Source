...
namespace BitGen { namespace bitstream {
	...
	public:
		explicit dfotTileLibBstr(FDU::cil_lib::tileLib* refTileLib = 0) : _refTileLib(refTileLib) {}

//		void setRefTileLib(FDU::cil_lib::tileLib* ref) { _refTileLib = ref; }
		...
		dfotTileBstr& getDfotTile(const std::string& tileName) { return *dfotTiles().find(tileName); }
