...
struct CilException : public Exception{
	CilException(const std::string& msg = "An error occurred during building CFG Lib") : Exception("[cil] " + msg) {}
};

struct CktException : public Exception{
	CktException(const std::string& msg = "An error occurred during building circuit") : Exception("[circuit] " + msg) {}
};

struct BstrException : public Exception{
	BstrException(const std::string& msg = "An error occurred during generating bitstream") : Exception("[bitstream] " + msg) {}
};
