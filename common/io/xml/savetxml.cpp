...
namespace COS {
	XML::NetlistWriter* TimingFactory::make_xml_write_handler() { return new XML::TNetlistWriter; }
...
namespace XML {
	...
	xml_node* TNetlistWriter::write_timing(xml_node* node, const TimingInfo& tinfo) {
