...
namespace COS { namespace XML {
	...
	protected:
		...
		virtual xml_node* write_property(xml_node* node, PropertyBase* prop, const Object* obj);
		virtual xml_node* write_config(xml_node* node, Config* cfg, const Object* obj);

		using DomBuilder::create_element;
		xml_node* create_element(xml_node* node, const char* name, const Object* obj, int copy_string = COPY_NONE);
		xml_node* create_element(xml_node* node, const string& name, const Object* obj, int copy_string = COPY_NONE)
