...
namespace LOG {
	...
	using sp_file_sink   = boost::shared_ptr<sinks::synchronous_sink<sinks::text_file_backend> >;
	using sp_stream_sink = boost::shared_ptr<sinks::synchronous_sink<sinks::text_ostream_backend> >;
