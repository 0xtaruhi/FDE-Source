...
namespace PACK {
	...
	public:
		...
		bool       has_more_match()
		{ return match_enumer_->has_more_elem(); }
		void       next_match();
	...
	class VCell {
		...
		struct PKFactor
		{
			...
			PKFactor()
				: is_clustered(false), touch_flag(false),
				  degree(0), conn_factor(0.),
	...
	public:
		...
		typedef boost::iterator_range<Match::InstMatch::const_iterator> const_instpairs_type;
		typedef boost::iterator_range<Match::InstMatch::iterator>       instpairs_type;

		const_instpairs_type inst_pairs() const { return const_instpairs_type(amatch_->begin(), amatch_->end()); }
		instpairs_type       inst_pairs()       { return instpairs_type(amatch_->begin(), amatch_->end());       }
	...
	inline Match::const_vcells_type Match::vcells() const { return vcells_.range(); }
