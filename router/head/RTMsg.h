...
namespace FDU { namespace RT {
	...
	inline std::ostream& operator<< (std::ostream& out, const MsgFormat& err_msg) { out << err_msg.to_string(); return out; }
	...
	const char* const err_msg[] = {
		...
		"[NETLIST ERROR]: the to_net\"%1%\" of last pip in net \"%2%\" does not connect a sink",		//NLTERR_LAST_PIP_ILLEGAL
		"[ROUTING ERROR]: instance \"%1%\" unplaced",								//RTERR_INST_UPLC
		"[ROUTING ERROR]: switch from \"%1%\" to \"%2%\" not exist",				//RTERR_UFND_SWH
		"[ROUTING ERROR]: unfound %1% \"%2%\" of net \"%3%\", "
		"please check the name or direction of the pin",							//RTERR_UFND_NODE
	...
	const char* const info_msg[] = {
		"Release 2.0 - route\n"
		"Copyright (c) 2006-2010 FPGA-SoftwareGP.MEKeylab.FDU   All rights reserved.",	//INFO_CPY_RGHT
